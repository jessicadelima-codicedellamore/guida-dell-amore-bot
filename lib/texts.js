...
export const MSG_ASK_EMAIL = `✉️ *Quase lá!*
Per attivare il *Premium* in automatico, scrivi il tuo *email di acquisto*:
\`/email iltuo@email.com\``;

export const MSG_EMAIL_OK = (e) => `✅ Email salvata: *${e}*. Se il pagamento è *APPROVATO*, il Premium si attiva subito.`;

export const MSG_EMAIL_BAD = `🚫 Formato email non valido. Esempio: \`/email nome@dominio.com\``;
